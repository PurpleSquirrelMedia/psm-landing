...
const PSM_AUTH = {
    ...
    async signUp(email, password, name) {
        try {
            ...
            const response = await fetch('https://evolution-reporting-wiki-maximum.trycloudflare.com/api/v1/auth/register', {
                method: 'POST',
    ...
    async signIn(email, password) {
        try {
            const response = await fetch('https://evolution-reporting-wiki-maximum.trycloudflare.com/api/v1/auth/login', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    async signInWithGoogle() {
        ...
        window.location.href = 'https://evolution-reporting-wiki-maximum.trycloudflare.com/api/v1/auth/google';
    },

    // Apple OAuth
    async signInWithApple() {
        window.location.href = 'https://evolution-reporting-wiki-maximum.trycloudflare.com/api/v1/auth/apple';
    },
    ...
    async signInWithSolana() {
        ...
        try {
            ...
            const nonceResp = await fetch(`https://evolution-reporting-wiki-maximum.trycloudflare.com/api/v1/auth/solana/nonce?wallet=${publicKey}`);
            ...
            // Verify with server
            const verifyResp = await fetch('https://evolution-reporting-wiki-maximum.trycloudflare.com/api/v1/auth/solana/verify', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    wallet: publicKey,
    ...
    async signOut() {
        try {
            await fetch('https://evolution-reporting-wiki-maximum.trycloudflare.com/api/v1/auth/logout', {
                method: 'POST',
    ...
    async handleCallback() {
        ...
        if (token) {
            ...
            const response = await fetch('https://evolution-reporting-wiki-maximum.trycloudflare.com/api/v1/auth/me', {
